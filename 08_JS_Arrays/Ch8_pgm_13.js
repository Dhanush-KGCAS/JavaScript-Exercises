var spacer = {
    ...
    line: function (length, character) {
      ...
      return longString.substring(longString.indexOf(character), length);
    },
  ...
  var showItem = function (player, itemNum){
    var Item = player.items[itemNum]
    var playerItem = player.name + ': ' + Item;
    console.log(playerItem); 
  }
  
  var addItem = function (player, itemAdd){
    var item = player.items.push(itemAdd)
    console.log(item);
  }

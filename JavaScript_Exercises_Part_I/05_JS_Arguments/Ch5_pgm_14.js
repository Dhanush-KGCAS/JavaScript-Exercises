...
console.log(showLine(10) + `\n${showLine(1)} ${player1.name} ${showLine(1)}\n` + showLine(10));
console.log(showStarLine(10) + `\n${showStarLine(1)} ${player1.name} ${showStarLine(1)}\n` + showStarLine(10));
/* Further Adventures
 *

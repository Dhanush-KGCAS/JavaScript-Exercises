...
showMessage = function (message, by, from) {
	console.log("The message is: " + message);
	console.log("The message was sent by: " + by);
	console.log("The message was sent from: " + from);
};

showMessage("It's full of stars!", 'Dhanush', 'Anonymous');

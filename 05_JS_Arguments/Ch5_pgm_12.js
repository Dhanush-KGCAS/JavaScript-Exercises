 ...
 * 
 * Answer: The playerName argument is in String Type, here the substring Method uses the starting and ending index values and prints a seperate string returning the value as a string.
 *
 ...
 * 
 * * Answer: The substring Method uses the starting and ending index values and prints a seperate string from the argument string returning the value as a string.
